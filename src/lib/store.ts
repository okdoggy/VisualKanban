...
import { seedActivities, seedComments, seedMindmapNodes, seedPermissions, seedProjects, seedTasks, seedUsers } from "@/lib/data/seed";
import { canSeeTask, resolveRole } from "@/lib/permissions/roles";
import type { AccessRole, Activity, FeatureKey, Task, TaskStatus, User, VisualKanbanState } from "@/lib/types";
